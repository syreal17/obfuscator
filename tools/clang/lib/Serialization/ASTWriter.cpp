...
void ASTWriter::WriteInputFiles(SourceManager &SourceMgr,
  ...
  Stream.EmitRecordWithBlob(OffsetsAbbrevCode, Record, (char*)data(InputFileOffsets), InputFileOffsets.size());
}
...
void ASTWriter::WriteSourceManagerBlock(SourceManager &SourceMgr,
  ...
  Stream.EmitRecordWithBlob(SLocOffsetsAbbrev, Record, (char*)data(SLocEntryOffsets), SLocEntryOffsets.size());
...
void ASTWriter::WritePreprocessor(const Preprocessor &PP, bool IsModule) {
  ...
  Stream.EmitRecordWithBlob(MacroOffsetAbbrev, Record,
                            (char*)data(MacroOffsets), MacroOffsets.size());
}
...
uint64_t ASTWriter::WriteDeclContextLexicalBlock(ASTContext &Context,
  ...
  Stream.EmitRecordWithBlob(DeclContextLexicalAbbrev, Record, (char*)data(Decls), Decls.size());
  return Offset;
}
...
void ASTWriter::WriteTypeDeclOffsets() {
  ...
  Stream.EmitRecordWithBlob(TypeOffsetAbbrev, Record, (char*)data(TypeOffsets), TypeOffsets.size());
  ...
  Stream.EmitRecordWithBlob(DeclOffsetAbbrev, Record, (char*)data(DeclOffsets), DeclOffsets.size());
}
...
void ASTWriter::WriteSelectors(Sema &SemaRef) {
  ...
  // Create and write out the blob that contains selectors and the method pool.
  {
    ...
    Stream.EmitRecordWithBlob(SelectorOffsetAbbrev, Record,
                              (char*)data(SelectorOffsets), SelectorOffsets.size());
  }
}
...
void ASTWriter::WriteIdentifierTable(Preprocessor &PP, 
  ...
  Stream.EmitRecordWithBlob(IdentifierOffsetAbbrev, Record,
                            (char*)data(IdentifierOffsets), IdentifierOffsets.size());
}
...
void ASTWriter::WriteASTCore(Sema &SemaRef,
  ...
  Stream.EmitRecordWithBlob(TuUpdateLexicalAbbrev, Record,
                            (char*)data(NewGlobalDecls), NewGlobalDecls.size());
